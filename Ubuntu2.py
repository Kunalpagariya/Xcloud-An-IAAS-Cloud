...
commands.getstatusoutput("sudo virt-install --hvm  --name "+osname+" --memory "+MEMORY+" --disk=/root/Desktop/OS/"+osname+".qcow2 --vcpus="+cpu+"  --cdrom /root/Desktop/OS/ubuntu.iso  --os-type linux --noautoconsole  --graphics vnc,listen=0.0.0.0,port="+port)
